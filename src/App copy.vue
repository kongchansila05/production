  ...
  <div id="nav">
    <nav class=" navbar navbar-expand-lg navbar-light bg-fan-primary">
        <div class="container-sm">
          ...
          <!-- <form hidden class="nav-item bg-whit nav-link search-type" style="background-color: white;border-radius:10px">
          ...
          <div class="new-mumu example" v-if="lang == 'en'">
            <router-link to="/livescore"  class="nav-link-example"><i class="fa fa-futbol-o text-white fa-spin"></i> LIVESCORE</router-link>
            <router-link to="/livestream"  class="nav-link-example"> <i class="fa fa-video-camera" style="color: red;"></i> LIVESTREAM</router-link>
            <router-link to="/article"  class="nav-link-example">NEWS</router-link>
          ...
          <div class="new-mumu example" v-if="lang == 'kh'">
            <router-link to="/livescore"  class="nav-link-example"><i class="fa fa-futbol-o text-white fa-spin"></i> ពិន្ទុបាល់</router-link>
            <router-link to="/livestream"  class="nav-link-example"><i class="fa fa-video-camera" style="color: red;"></i> ផ្សាយផ្ទាល់</router-link>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent" >
            <div class="navbar-nav mr-auto" v-if="lang == 'en'">
                <span><router-link to="/livescore" class="nav-item nav-link"><i class="fa fa-futbol-o fa-spin text-white"></i> LIVESCORE</router-link></span>
                <span><router-link to="/livestream" class="nav-item nav-link"><i class="fa fa-video-camera" style="color: red;"></i> LIVESTREAM</router-link></span>
                <router-link to="/article" class="nav-item nav-link">NEWS</router-link>
            ...
            <div class="navbar-nav mr-auto" v-else>
                <span><router-link to="/livescore" class="nav-item nav-link"> <i class="fa fa-futbol-o text-white fa-spin"></i> ពិន្ទុបាល់</router-link></span>
                <router-link to="/livestream" class="nav-item nav-link"><i class="fa fa-video-camera" style="color: red;"></i> ផ្សាយផ្ទាល់</router-link>
        ...
        <div style="padding: 5px;" class="change_lang">  
          <div class="dropdown">
            <button class="dropbtn" @click="popup_lang()"><img v-bind:src="'/icon/'+ this.lang+'.png'" alt=""></button>
