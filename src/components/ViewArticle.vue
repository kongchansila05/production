                    ...
                    <div class=" flex flex-col from-gray-100 gap-y-4 lg:gap-y-4 md:gap-y-4 rounded-md">
                        <div class="bg-transparent rounded px-2">
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo2">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo2" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo3">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo3" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo4">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo4" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo5">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo5" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo6">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo6" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo7">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo7" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo8">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo8" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo9">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo9" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo10">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo10" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo11">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo11" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="w-full mx-auto lg:px-0" v-if="value.photo12">
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo12" 
                                        alt="" width="1200" height="675" class="radis-sila">
                                    </p>
                                </div>
                            </div>
                            ...
                            <span class=" _50f7">{{viewer}} <b>Viewer</b></span>
                        </div>
                    </div>                            
