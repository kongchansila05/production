...
<template>
  <div v-if="sponser == true" class=" container-sm vfm vfm--inset vfm--absolute" style="z-index: 1000;pointer-events: none;">
    ...
    <div tabindex="-1" class="vfm__container vfm--absolute vfm--inset vfm--outline-none modal-container" style="">
      <div class="vfm__content modal-content">
        <div style="font-weigt: bold;color=#2f2151;font-family:Hanuman; text-align: center; float: right; width: 50%; margin-left: 50%;">
        <span style="float: right; color: white; font-size: 20px;" @click="NotificationShow">
          <button>X</button>
        </span>
...
<div class="mt-2"></div>
  ...
  <a class="tgme_action_button_img">
    <img style="width: 50px; border-radius: 50%;" src="https://cdn5.telegram-cdn.org/file/MzArJf0AuxDW2C0cgfC9AdNckP4UyJ5gtdm2kVDsiUkcWj84p8cJrTw7ZZ_TxfnkpV1Ar1ARy2fGSRcpAEA5SMMh53zX2kNeEb5q8iGbvmzPYQYwhnbFxfaGr-Oe9vjQQ3gVEX9OlA_6s7mDszLC-p5sfNqCRXanB9-kn75M3t9j9Wf1qpVudaXpoyrE8MoZKwXWoeau2EG7wrFQbwSpYpoeN2NyciIOJRyWQ0bEMSN9TpYjrHWSyNhLzIJDJxU_HxKix0DhSSet9UVjyYRRSuPlzHQl8UPBgp29_Y9YyNPY0e0Oavu5iKKEugYxBIDUv53u3ueaEVH4jp5ws6GWzg.jpg">
  </a>
  <a class="tgme_action_button_new shine" href="tg://resolve?domain=newssportskh">View in Telegram</a>
</div>
